package com.hendisantika.springbootresterrorhandling;
...
public class SpringbootRestErrorHandlingApplication {

    public static void main(String[] args) {
        SpringApplication.run(SpringbootRestErrorHandlingApplication.class, args);
    }
